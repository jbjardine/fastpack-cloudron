...
- Require explicit confirmation before trusting a deploy config supplied Cloudron URL.
- Reject symlinks and non-regular files when creating deploy CLI source archives.
- Verify the Docker CLI tarball checksum in generated DooD Dockerfiles.

## [2.1.2] - 2026-06-20

### Security

- Hardened public release workflow and CLI build chain.
- Updated Go dependencies and target Go version for rebuilt release binaries.
- Removed legacy Build Service helper app and tracked CLI binaries from the repository.
